	...
	<main>
		...
		<div class="container">
			...
			<div class="pricing-header mt-5 p-3 pb-md-4 mx-auto text-center mb-5">
				...
				<p class="fs-5 text-muted">faucibus euismod orci. Donec id elit
					tristique</p>
			</div>
			<div
				style="display: flex; align-items: center; justify-content: center;">
				<div class="row w-100">
					<div class="col-lg-4 text-center mb-5">
						<img class="rounded-circle" src="/assets/custom/images/noimg.jpg"
					...
					<div>
						<div
							...
							<div class="col p-4 d-flex flex-column position-static">
								...
								<p class="card-text mb-auto">Urna pulvinar tincidunt nec in
									purus. Proin sodales tristique cursus.</p>
							</div>
							<div class="col-auto d-none d-lg-block">
								<svg class="bd-placeholder-img" width="200" height="200"
									xmlns="http://www.w3.org/2000/svg" role="img"
									aria-label="Placeholder: venenatis"
									preserveAspectRatio="xMidYMid slice" focusable="false">
									<title>Placeholder</title><rect width="100%" height="100%"
										fill="#55595c"></rect>
									<text x="40%" y="50%" fill="#eceeef" dy=".3em" class="h3">Venenas</text></svg>
							</div>
						</div>
					</div>
					<div>
						<div
							...
							<div class="col p-4 d-flex flex-column position-static">
								...
								<p class="card-text mb-auto">Integer vitae nunc at lorem
									molestie ornare quis quis orci.</p>
							</div>
							<div class="col-auto d-none d-lg-block">
								<svg class="bd-placeholder-img" width="200" height="200"
									xmlns="http://www.w3.org/2000/svg" role="img"
									aria-label="Placeholder: sodales"
									preserveAspectRatio="xMidYMid slice" focusable="false">
									<title>Placeholder</title><rect width="100%" height="100%"
										fill="#55595c"></rect>
									<text x="40%" y="50%" fill="#eceeef" dy=".3em" class="h3">Sodales</text></svg>
							</div>
						</div>
					</div>
					<div>
						<div
							...
							<div class="col p-4 d-flex flex-column position-static">
								...
								<p class="card-text mb-auto">Ut dictum quam elit, eu
									porttitor tellus tempor commodo.</p>
							</div>
							<div class="col-auto d-none d-lg-block">
								<svg class="bd-placeholder-img" width="200" height="200"
									xmlns="http://www.w3.org/2000/svg" role="img"
									aria-label="Placeholder: pellentesque"
									preserveAspectRatio="xMidYMid slice" focusable="false">
									<title>Placeholder</title><rect width="100%" height="100%"
										fill="#55595c"></rect>
									<text x="40%" y="50%" fill="#eceeef" dy=".3em" class="h3">Pellens</text></svg>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="pricing-header mt-5 p-3 pb-md-4 mx-auto text-center mb-5">
				...
				<p class="fs-5 text-muted">Fusce ipsum ex, tristique a enim et,
					faucibus euismod orci</p>
			</div>
			<div
				style="display: flex; align-items: center; justify-content: center;"
				class="bg-light">
				...
				<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
					<div
						...
						<div class="text-bg-primary shadow-sm mx-auto p-3 text-start"
							style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;">
							<p>
							<h5>Etiam eu orci dictum</h5>
							</p>
							<p>
							<h5>Duis id sem a velit feugiat</h5>
							</p>
							<p>
							<h5>Porttitor augue lacinia, bibendum quam</h5>
							</p>
						</div>
					</div>
					<div
						...
						<div class="my-3 py-3">
							...
							<p class="lead">Duis id sem a velit feugiat cursus at a
								purus.</p>
						</div>
						<div class="text-bg-light shadow-sm mx-auto p-3 text-start"
							style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;">
							<p>
							<h5>Etiam eu orci dictum</h5>
							</p>
				...
				<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 w-100">
					<div class="col">
						<div class="card shadow-sm">
							<div class="text-bg-info text-center w-100"
								style="height: 175px;">
			...
			<div
				...
				<div class="card text-white bg-danger mb-3 mx-2"
					style="width: 18rem; max-width: 20rem;">
				...
				<div class="card text-white bg-info mb-3 mx-2"
					style="width: 18rem; max-width: 20rem;">
					<div class="card-header h5">Aliquam varius</div>
					<div class="card-body">
						<h6>Cras at lorem tempor</h6>
			...
			<div class="pricing-header mt-5 p-3 pb-md-4 mx-auto text-center mb-5">
				...
				<p class="fs-5 text-muted">Integer ac nunc et ante accumsan
					pulvinar.</p>
				<p class="fs-5 text-muted">Proin gravida leo vel velit bibendum,
					ac lacinia ex ornare.</p>
			</div>
			<div
				style="display: flex; align-items: center; justify-content: center;"
				class="bg-light">
				<ul class="list-group list-group-flush w-75">
					<li class="list-group-item h3 text-center text-bg-secondary">Vestibulum
						in sapien</li>
					<li class="list-group-item mt-3">Vivamus ac orci eget arcu
						ultrices pharetra quis vitae nibh.</li>
					<li class="list-group-item mt-3">Integer a quam et augue
						suscipit tincidunt at eu elit.</li>
					<li class="list-group-item mt-3">Nullam at mauris porttitor,
						auctor lacus sit amet, pulvinar elit.</li>
					<li class="list-group-item mt-3">Praesent in massa vel est
						sodales posuere.</li>
					<li class="list-group-item mt-3">Praesent tristique diam sed
						magna blandit efficitur.</li>
					<li class="list-group-item mt-3">Duis ultrices nisi id tortor
						rhoncus, eget tristique libero feugiat.</li>
					<li class="list-group-item fs-5 mt-3 text-center text-success"><p>Sed
							aliquet libero vitae ullamcorper luctus.</p>
						<p>Donec eu augue et libero luctus euismod in vel nunc.</p></li>
				</ul>
			</div>
		</div>
	</main>
