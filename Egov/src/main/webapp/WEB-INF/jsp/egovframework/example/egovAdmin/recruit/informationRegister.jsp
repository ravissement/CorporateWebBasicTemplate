...
<c:set var="registerFlag"
	value="${empty recruitVO.idx ? 'create' : 'modify'}" />
<title>Information <c:if test="${registerFlag == 'create'}">
...
<validator:javascript formName="recruitVO" staticJavascript="false"
						...
						<table class="table">
							...
							<tr>
								<td style="font-weight: bold;"
									class="text-center text-secondary"><label for="useYn"><spring:message
											code="title.recruit.useYn" /></label></td>
							...
							<tr>
								<td style="font-weight: bold;"
									class="text-center text-secondary"><label for="regUser"><spring:message
											code="title.recruit.regUser" /></label></td>
							...
							<tr>
		        				...
		        				&nbsp;<form:errors path="attachFile" />
			        				...
			        				<a
												href="<c:url value='/egovAdmin/recruit/fileDownload.do?fileSaveName=${recruitVO.attachSaveName}&fileOriName=${recruitVO.attachOriName}'/> "
