...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	function fn_egov_select(id) {
		document.listForm.selectedId.value = id;
	   	document.listForm.action = "<c:url value='/client/noticeView.do'/>";
	   	document.listForm.submit();
	}
	
	/* 글 목록 화면 function */
	function fn_egov_selectList() {
		document.listForm.action = "<c:url value='/client/notice.do'/>";
	   	document.listForm.submit();
	}
	...
	<div class="container">
		...
		<form:form commandName="searchVO" id="listForm" name="listForm" method="post">
	        ...
	        <div id="content_pop" class="mt-5">
	        	<div id="search"  class="Justify-content-around">
	        		<ul style="list-style:none;" class="nav justify-content-end">
	        	...
	        	<!-- List -->
	        	<div id="table">
	        		<table class="table table-hover mt-2" summary="글번호, 제목, 내용, 첨부파일, 등록일 표시하는 테이블">
	        			<caption style="visibility:hidden">글번호, 제목, 내용, 첨부파일, 등록일  표시하는 테이블</caption>
	        			<tr class="bg-light text-center">
	        				<th>No</th>
	        				<th class="w-75"><spring:message code="title.notice.title" /></th>
	            			...
	            			<tr>
	            				...
	            				<td class="text-center py-3">
	            					<c:if test="${result.attachSaveName != null}">
	            						<a href="<c:url value='/client/fileDownload.do?fileSaveName=${result.attachSaveName}&fileOriName=${result.attachOriName}'/> ">
