            ...
            <div class="p-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
						...
						<p class="lead mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque velit sapien, iaculis vel augue at, bibendum tristique risus. Vestibulum congue tristique tincidunt. Cras mi mauris, vehicula sit amet ligula in, vehicula fermentum mauris. Etiam congue commodo dictum. Quisque at interdum dui. Aliquam suscipit finibus turpis, quis bibendum tellus accumsan eget. Sed ligula magna, finibus id ligula id, ultrices efficitur sapien. Phasellus egestas risus et varius blandit.</p>
                    	<ul class="lead mt-5">
                    		<li>Mauris</li>
                    		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    		<li>Aenean</li>
                    		<p>Aliquam blandit orci sit amet augue tempor, a hendrerit ante pharetra.</p>
                    		<li>Praesent</li>
