...
<body>
			...
			<table class="table my-5">
				...
				<tbody>
					<tr>
						...
						<td>000)000-0000</td>
						<td><span id="email_1">edmund@xxx.com</span>
							&nbsp;&nbsp;&nbsp; <a href="javascript:void(0);" id="copy_1"
							onClick="copyToClipBoard(this.id)"> <svg
					...
					<tr>
						...
						<td>000)000-0000</td>
						<td><span id="email_2">benedict@xxx.net</span>
							&nbsp;&nbsp;&nbsp; <a href="javascript:void(0);" id="copy_2"
							onClick="copyToClipBoard(this.id)"> <svg
									xmlns="http://www.w3.org/2000/svg" width="20" height="20"
									fill="currentColor" class="bi bi-envelope-check"
									viewBox="0 0 16 16">
					...
					<tr>
						...
						<td>000)000-0000</td>
						<td><span id="email_3">edgar@xxx.co.kr</span>
							&nbsp;&nbsp;&nbsp; <a href="javascript:void(0);" id="copy_3"
							onClick="copyToClipBoard(this.id)"> <svg
									xmlns="http://www.w3.org/2000/svg" width="20" height="20"
									fill="currentColor" class="bi bi-envelope-check"
									viewBox="0 0 16 16">
					...
					<tr>
						...
						<td>System integration</td>
						<td>000)000-0000</td>
						<td><span id="email_4">antony@xxx.com</span>
							&nbsp;&nbsp;&nbsp; <a href="javascript:void(0);" id="copy_4"
							onClick="copyToClipBoard(this.id)"> <svg
									xmlns="http://www.w3.org/2000/svg" width="20" height="20"
									fill="currentColor" class="bi bi-envelope-check"
									viewBox="0 0 16 16">
					...
					<tr>
						...
						<td>000)000-0000</td>
						<td><span id="email_5">oscar@xxx.co.kr</span>
							&nbsp;&nbsp;&nbsp; <a href="javascript:void(0);" id="copy_5"
							onClick="copyToClipBoard(this.id)"> <svg
									xmlns="http://www.w3.org/2000/svg" width="20" height="20"
									fill="currentColor" class="bi bi-envelope-check"
									viewBox="0 0 16 16">
					...
					<tr>
						...
						<td>Brand manager</td>
						<td>000)000-0000</td>
						<td><span id="email_6">richard@xxx.co.kr</span>
							&nbsp;&nbsp;&nbsp; <a href="javascript:void(0);" id="copy_6"
							onClick="copyToClipBoard(this.id)"> <svg
									xmlns="http://www.w3.org/2000/svg" width="20" height="20"
									fill="currentColor" class="bi bi-envelope-check"
									viewBox="0 0 16 16">
					...
					<tr>
						...
						<td>000)000-0000</td>
						<td><span id="email_7">walter@xxx.co.kr</span>
							&nbsp;&nbsp;&nbsp; <a href="javascript:void(0);" id="copy_7"
							onClick="copyToClipBoard(this.id)"> <svg
									xmlns="http://www.w3.org/2000/svg" width="20" height="20"
									fill="currentColor" class="bi bi-envelope-check"
									viewBox="0 0 16 16">
					...
					<tr>
						...
						<td>Marketing Communication</td>
						<td>000)000-0000</td>
						<td><span id="email_8">noel@xxx.com</span> &nbsp;&nbsp;&nbsp;
							<a href="javascript:void(0);" id="copy_8"
							onClick="copyToClipBoard(this.id)"> <svg
									xmlns="http://www.w3.org/2000/svg" width="20" height="20"
									fill="currentColor" class="bi bi-envelope-check"
									viewBox="0 0 16 16">
					...
					<tr>
						...
						<td>000)000-0000</td>
						<td><span id="email_9">elizabethe@xxx.co.kr</span>
							&nbsp;&nbsp;&nbsp; <a href="javascript:void(0);" id="copy_9"
							onClick="copyToClipBoard(this.id)"> <svg
									xmlns="http://www.w3.org/2000/svg" width="20" height="20"
									fill="currentColor" class="bi bi-envelope-check"
									viewBox="0 0 16 16">
					...
					<tr>
						...
						<td>Accounting, Human Resources</td>
						<td>000)000-0000</td>
						<td><span id="email_10">naomi@xxx.com</span>
							&nbsp;&nbsp;&nbsp; <a href="javascript:void(0);" id="copy_10"
							onClick="copyToClipBoard(this.id)"> <svg
									xmlns="http://www.w3.org/2000/svg" width="20" height="20"
									fill="currentColor" class="bi bi-envelope-check"
									viewBox="0 0 16 16">
	...
	<div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
		<div id="liveToast" class="toast hide" role="alert"
			...
			<div class="toast-header">
				<strong class="me-auto">CorporateName</strong> <small>now</small>
	...
	<script>
		...
		function copyToClipBoard(clickId) {
			var content = document.getElementById("email_"
					+ clickId.substring(5)).innerText;
