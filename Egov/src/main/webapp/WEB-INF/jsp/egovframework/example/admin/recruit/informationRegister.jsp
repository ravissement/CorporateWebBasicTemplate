...
<head>
<meta charset="UTF-8">
<c:set var="registerFlag" value="${empty recruitVO.idx ? 'create' : 'modify'}"/>
<title>
	Information 	<c:if test="${registerFlag == 'create'}"><spring:message code="button.create" /></c:if>
					<c:if test="${registerFlag == 'modify'}"><spring:message code="button.modify" /></c:if>
</title>
<!--For Commons Validator Client Side-->
<script type="text/javascript" src="<c:url value='/cmmn/validator.do'/>"></script>
<validator:javascript formName="recruitVO" staticJavascript="false" xhtml="true" cdata="false"/>
...
<main>
	...
	<div class="container">
		<%@ include file="/assets/includes/tabRecruitAdmin.jsp" %><!-- tabs -->
		<!-- list -->
		...
		<form:form commandName="recruitVO" id="detailForm" name="detailForm" enctype="multipart/form-data">
		    <div>
		    	<div id="table">
		    	<table class="table">
		    		...
		    		<tr>
		    			<td style="font-weight:bold;" class="text-center text-secondary"><label for="title"><spring:message code="title.recruit.title" /></label></td>
		    			<td>
		    		...
		    		<tr>
		    			<td style="font-weight:bold;" class="text-center text-secondary"><label for="useYn"><spring:message code="title.recruit.useYn" /></label></td>
		    			<td>
		    		...
		    		<tr>
		    			<td style="font-weight:bold;" class="text-center text-secondary"><label for="contents"><spring:message code="title.recruit.contents" /></label></td>
		    			<td>
		    				<form:textarea path="contents" rows="5" cols="58" class="form-control" />&nbsp;<form:errors path="contents" />
		                </td>
		    		</tr>
		    		<tr>
		    			<td style="font-weight:bold;" class="text-center text-secondary"><label for="regUser"><spring:message code="title.recruit.regUser" /></label></td>
		    			<td>
		                    <c:if test="${registerFlag == 'modify'}">
		    		...
		    		<tr>
		    			<td style="font-weight:bold;" class="text-center text-secondary"><label for="attach"><spring:message code="title.recruit.attach" /></label></td>
		    			<td>
							<c:if test="${registerFlag == 'modify'}">
