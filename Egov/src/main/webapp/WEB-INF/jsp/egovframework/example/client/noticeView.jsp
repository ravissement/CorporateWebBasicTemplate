					...
					<div id="table">
						<table class="table" style="table-layout: fixed;">
							<tr>
								...
								<td><c:out value="${noticeVO.title}" /></td>
							</tr>
							<tr>
								...
								<td><textarea class="contents" readonly><c:out
											value="${noticeVO.contents}" /></textarea></td>
							</tr>
							<tr>
								<td style="font-weight: bold;"
									class="text-center text-secondary"><label for="regDate"><spring:message
											code="title.notice.regDate" /></label></td>
								<td><fmt:parseDate value="${noticeVO.regDate}"
							...
							<tr>
								...
								<td><c:if test="${noticeVO.attachSaveName != null}">
		        				${noticeVO.attachOriName} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		        				<a
											href="<c:url value='/client/fileDownload.do?fileSaveName=${noticeVO.attachSaveName}&fileOriName=${noticeVO.attachOriName}'/> "
