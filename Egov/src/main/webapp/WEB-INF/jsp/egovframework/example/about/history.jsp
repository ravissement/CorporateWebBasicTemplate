				...
				<div class="px-5 w-100">
					...
					<div class="row gx-5 mb-5">
						...
						<div class="col-lg-4 text-lg-end">
							<div class="text-gray-400 small">April 2015 - Present</div>
						</div>
					</div>
					<div class="row gx-5 mb-5">
						<div class="col-lg-8">
						...
						<div class="col-lg-4 text-lg-end">
							<div class="text-gray-400 small">October 2013</div>
						</div>
					</div>
					<div class="row gx-5 mb-5">
						<div class="col-lg-8">
						...
						<div class="col-lg-4 text-lg-end">
							<div class="text-gray-400 small">April 2011</div>
						</div>
					</div>
					<div class="row gx-5 mb-5">
						<div class="col-lg-8">
						...
						<div class="col-lg-4 text-lg-end">
							<div class="text-gray-400 small">June 2010</div>
						</div>
					</div>
					<div class="row gx-5 mb-5">
						<div class="col-lg-8">
						...
						<div class="col-lg-4 text-lg-end">
							<div class="text-gray-400 small">September 2005</div>
						</div>
					</div>
					<div class="row gx-5 mb-5">
						<div class="col-lg-8">
						...
						<div class="col-lg-4 text-lg-end">
							<div class="text-gray-400 small">March 2004</div>
						</div>
					</div>
					<div class="row gx-5 mb-5">
						<div class="col-lg-8">
						...
						<div class="col-lg-4 text-lg-end">
							<div class="text-gray-400 small">July 2003</div>
						</div>
					</div>
					<div class="row gx-5 mb-5">
						<div class="col-lg-8">
						...
						<div class="col-lg-4 text-lg-end">
							<div class="text-gray-400 small">April 2002</div>
						</div>
					</div>
				</div>
			</div>
